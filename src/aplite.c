...
static BitmapLayer *s_circle_layer, *s_stone_layer, *s_stone_layer_2;

static GBitmap *s_circle_bitmap, *s_charge_bitmap, *s_stone_bitmap, *s_stone_bitmap_2;
...
GBitmap *bg_bitmap, *bgc_bitmap;
GBitmap *hands_bitmap_0, *hands_bitmap_1, *hands_bitmap_2;
GBitmap *sparks_bitmap_1, *sparks_bitmap_2, *sparks_bitmap_3, *sparks_bitmap_4;
GBitmap *rune_bitmap;
...
void main_window_load(Window *window) {
	...
	bgc_bitmap = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_BG_CIRCLE);
	...
	sparks_bitmap_1 = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_SPARKS_1);
	sparks_bitmap_2 = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_SPARKS_2);
	sparks_bitmap_3 = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_SPARKS_3);
	sparks_bitmap_4 = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_SPARKS_4);
	...
	// Time layer
	time_layer = text_layer_create(GRect(0, 168-62, 144, 62));
	...
	// Date layer
	date_layer = text_layer_create(GRect(0, 168-27, 144, 25));
...
void main_window_unload(Window *window) {
	...
	gbitmap_destroy(bgc_bitmap);
	gbitmap_destroy(hands_bitmap_0);
	gbitmap_destroy(hands_bitmap_1);
	gbitmap_destroy(hands_bitmap_2);
	gbitmap_destroy(sparks_bitmap_1);
	gbitmap_destroy(sparks_bitmap_2);
	gbitmap_destroy(sparks_bitmap_3);
	gbitmap_destroy(sparks_bitmap_4);
